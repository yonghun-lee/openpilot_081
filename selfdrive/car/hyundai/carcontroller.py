...
class CarController():
  def __init__(self, dbc_name, CP, VM):
    ...
    if CP.lateralTuning.which() == 'pid':
      self.str_log2 = 'TUNE={:0.2f}/{:0.3f}/{:0.2f}/{:0.5f}'.format(CP.lateralTuning.pid.kpV[0], CP.lateralTuning.pid.kiV[0], CP.lateralTuning.pid.kdV[0], CP.lateralTuning.pid.kf)
